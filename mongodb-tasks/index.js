...
function update() {
  task
    .updateMany({ Completed: false }, { Completed: true })
...
//deletedata("create Repository");

add("complete Stige assignment", true);
add("create Repository", false);
add("Submit link on Stige", true);
add("Start week 8", false);
read();
update();
deletedata("create Repository");
